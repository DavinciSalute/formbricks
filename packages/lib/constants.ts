...
export const MOLECULER_TRANSPORTER = env.MOLECULER_TRANSPORTER;
export const MOLECULER_MICROSERVICE_CLIENT_NAME = env.MOLECULER_MICROSERVICE_CLIENT_NAME;
export const MOLECULER_MICROSERVICE_CLIENT_SECRET = env.MOLECULER_MICROSERVICE_CLIENT_SECRET;
